...
//   MWP::Matrix<T> x = A_star.subMatrix(0, A_star._rows, 0, 1); // column
//   vector MWP::Matrix<T> hu; T beta; T maxVal = x.colMax(0); x = x * ((T)1.0f
//   / maxVal);
...
//     throw std::invalid_argument("A matriz deve ter mais linhas que
//     colunas.");
//   }
